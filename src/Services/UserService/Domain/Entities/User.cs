...
public class User : Entity<Guid>, IAggregateRoot
{
    ...
    public static async Task<User> CreateClientAsync(string email, string username, string password, IPasswordService passwordService, IVerificationCodeGenerator verificationCodeGenerator)
